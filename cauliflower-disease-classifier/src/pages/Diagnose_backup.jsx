...
import { Upload, Loader2, CheckCircle2, AlertCircle, FileImage, Sparkles, ArrowRight } from "lucide-react";

/* Diagnose Page – AgroScan (Professional & Animated) --------------------
   • Two‑column layout with smooth animations
   • Modern gradient designs and professional UI
...
export default function Diagnose() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-lime-50/30 to-green-50/40 flex flex-col items-center py-16 px-6 lg:px-12 overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-lime-400/10 rounded-full blur-3xl -z-10"></div>
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-green-400/10 rounded-full blur-3xl -z-10"></div>
      ...
      >
        ...
        >
          <span className="bg-gradient-to-r from-green-100 to-lime-100 text-emerald-800 px-5 py-2 rounded-full text-sm font-semibold tracking-wide shadow-sm">
        ...
        <p className="text-lg sm:text-xl text-gray-700 max-w-2xl mx-auto">
          Upload a cauliflower image and get AI-powered disease classify with 
          <strong className="text-green-700"> 98%+ accuracy</strong> in seconds.
        </p>
      </motion.header>
